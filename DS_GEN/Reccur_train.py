...
for label in label_kelas:
    ...
    for _, row in df[df['label']==label].iterrows():
        ...
        dirpath = os.getcwd()
        target_dir = os.path.join(dirpath, "recur_dataset/train")
        ...
        if (index <= 100):
            ...
            #dfx = dfx.append(row, ignore_index=True)
...
output_filename = "recurr_train.pickle"
dfx.to_pickle(output_filename)  